...
var JqueryDialog = {
    ...
    alert:function(msg){
        JqueryDialog.init("消息", msg,null, 300, 220, false, true, true);
    },
	...
	Open:function(dialogTitle, iframeSrc, iframeWidth, iframeHeight){
		JqueryDialog.init(dialogTitle, null,iframeSrc, iframeWidth, iframeHeight, true, true, true);
	},
	...
	Open1:function(dialogTitle, iframeSrc, iframeWidth, iframeHeight, isSubmitButton, isCancelButton, isDrag){
		JqueryDialog.init(dialogTitle, null, iframeSrc, iframeWidth, iframeHeight, isSubmitButton, isCancelButton, isDrag);
	},
	...
	/// <param name="isCancelButton">是否呈现“取消”按钮</param>
	/// <param name="isDrag">是否支持拖拽</param>
	init:function(dialogTitle,msg,iframeSrc, iframeWidth, iframeHeight, isSubmitButton, isCancelButton, isDrag){
        ...
        if(msg ==undefined)
            ...
            _jd_dialog_m_b_2.css({"paddingTop":"5px","paddingLeft":"10px"});
            _jd_dialog_m_b_2.html(msg);
        }
		...
		if(isCancelButton){
            var txt=JqueryDialog.cSubmitText;
            if(msg ==undefined)
                txt=JqueryDialog.cCancelText;
			_jd_dialog_m_t.append("<span class='jd_dialog_m_t_s'><input id='jd_cancel' value='"+txt+"' type='button' onclick='JqueryDialog.Close();' /></span>");
		}
